        ...
        <div className="about_container">
          <div className="about_text">
            ...
            <p>
              ...
              & Dragons player and DM of a few games myself. I'm also an avid reader with a bad habit of buying every
              single book I see that catches my eye when I walk into a book store - I've since banned myself from
              walking into them until I have a place to store all of them, as I cannot control myself; fun fact!
            </p>
            <p>
              My background in writing ties into this pretty heavily, I've been scribbling short stories ever since I
              could pick up and hold a pencil. My writing grows with every coming year, becoming more complex, the
              worlds I create becoming more vibrant and filled with life. It's something I've always been naturally good
              at, and while it may be a ways out, my dream is to one day publish one of the many stories I have to tell.
            </p>
            <p>
            ...
            <p>
              I see every day as an opportunity to push the boundaries, to go beyond what I ever thought myself capable
              of and achieve new heights that I have only ever dreamed of. There are only so many hours in the day, I do
